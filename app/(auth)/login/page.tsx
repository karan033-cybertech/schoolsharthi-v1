      ...
      <div className="w-full max-w-sm rounded-2xl border border-[#E5E7EB] bg-white p-8 shadow-sm">
        ...
        >
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full rounded-xl bg-[#111111] py-3 font-semibold text-white transition-all hover:bg-gray-800 disabled:opacity-60"
          >
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-[#E5E7EB] py-2.5 text-sm font-medium transition-all hover:bg-gray-50"
        >
          <GoogleIcon />
